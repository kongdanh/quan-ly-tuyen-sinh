...
/**
 * Hằng số GIAO DIỆN (UI) – SGU Design System v1.0.0
 */
public class UIConstants {
    ...
    public static final String FONT_FAMILY_FALLBACK = "Arial, sans-serif";
    ...
    // 23. LOGIN FORM
    // ================================================================
    public static final int LOGIN_WIDTH = 1100;
    public static final int LOGIN_HEIGHT = 650;
    public static final int LOGIN_HEADER_HEIGHT = 40;
    public static final int LOGIN_INPUT_HEIGHT = 44;
    public static final int LOGIN_INPUT_RADIUS = 10;
    public static final int LOGIN_BTN_HEIGHT = 46;
    public static final int LOGIN_BTN_RADIUS = 8;
    public static final int LOGIN_ICON_SIZE = 120;
    public static final int LOGIN_LEFT_WIDTH = 550;
    public static final int LOGIN_TITLE_FONT_SIZE = 28;
    public static final int LOGIN_FORM_WIDTH = 380;
    public static final String LOGIN_GRADIENT_TOP = "#1e5aa0";
    public static final String LOGIN_GRADIENT_BOTTOM = "#164276";
    ...
    public static final String DASH_TEXT_DARK = "#111827";
    public static final String DASH_TEXT_MUTED = "#6B7280";
    public static final String DASH_GRID_LINE = "#E5E7EB";
    public static final String DASH_SELECT_BG = "#E0E7FF";
    public static final String DASH_ZEBRA_ALT = "#F9FAFB";
    public static final String DASH_ACCENT_SUCCESS = "#10B981";
    public static final String DASH_ACCENT_AMBER = "#F59E0B";
    public static final String DASH_ACCENT_ROSE = "#EF4444";
    public static final String DASH_ACCENT_PURPLE = "#8B5CF6";
    public static final String DASH_ACTIVE_BAR = "#3B82F6";
    public static final int DASH_MENU_ITEM_HEIGHT = 42;
    public static final int DASH_SIDEBAR_PAD = 20;
    public static final int DASH_HEADER_TITLE_SIZE = 32;
    public static final int DASH_HEADER_SUB_SIZE = 14;
    public static final int DASH_CARD_RADIUS = 12;
    public static final int DASH_CTRL_BTN_W = 46;
}