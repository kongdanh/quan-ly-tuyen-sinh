...
import com.tuyensinh.admin.ui.dialog.NganhToHopFormDialog; // Bạn sẽ cần tạo file này sau
...
// import com.tuyensinh.service.NganhService; // Giả định bạn có service này để lấy tên ngành
// import com.tuyensinh.service.ToHopService; // Giả định bạn có service này để lấy tên tổ hợp
...
public class NganhToHopPanel extends BaseTablePanel<NganhToHop> {
   ...
   @Override
    protected void setupExtras() {
        ...
        List<Nganh> dsNganh = new NganhService().getAll();
